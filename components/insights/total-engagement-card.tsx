...
interface TotalEngagementCardProps {
  engagement: {
    views: number
    likes: number
    retweets: number
...
export function TotalEngagementCard({ engagement }: TotalEngagementCardProps) {
  return (
    <motion.div
    ...
    >
      <h3 className="text-lg font-semibold mb-4">Total Today's Engagement</h3>
